...
const EditWorkout = ({ workout, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await updateWorkout(workout.id, workoutData);
  ...
  return (
    <div className="w-full max-w-md mx-auto p-3 bg-white shadow-md rounded-lg">
      <h2 className="text-lg font-semibold text-center text-gray-800 mb-2">Edit Workout</h2>
