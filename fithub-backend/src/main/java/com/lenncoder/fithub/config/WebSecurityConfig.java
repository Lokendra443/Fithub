package com.lenncoder.fithub.config;

import com.lenncoder.fithub.config.jwt.AuthTokenFilter;
import com.lenncoder.fithub.config.jwt.JwtAuthEntryPoint;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/api/workout/**").hasAnyRole("USER", "ADMIN")
